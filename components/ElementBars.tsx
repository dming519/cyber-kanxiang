...
export function ElementBars({ chart }: Props) {
  ...
  return (
    <div className="rounded-2xl border border-purple-500/30 bg-black/30 p-5 backdrop-blur-sm">
      <div className="mb-3 flex items-baseline justify-between">
        <h3 className="font-serif text-lg text-purple-200 tracking-wider">五行能量</h3>
