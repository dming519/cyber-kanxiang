...
export default function LoginPage() {
  return (
    <main className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-7xl items-center justify-center px-5 py-12 sm:px-6">
      <section className="w-full max-w-md rounded-2xl border border-[#edeade]/10 bg-[#2e261f]/75 p-6 shadow-[0_24px_80px_-56px_rgba(0,0,0,1)] backdrop-blur-sm sm:p-8">
        <div className="text-center">
          <div className="mx-auto grid size-14 place-items-center rounded-xl border border-brand-primary/35 bg-brand-light font-serif text-2xl text-brand-primary">
            相
          </div>
